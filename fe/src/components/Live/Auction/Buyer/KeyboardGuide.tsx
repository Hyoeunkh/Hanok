      ...
      <div className="flex items-stretch gap-4 px-4 py-3">
        ...
        <div className="flex flex-col justify-center gap-3 text-[11px] text-neutral-400">
          <div className="flex items-center gap-2">
            <span className="inline-flex h-7 items-center justify-center rounded bg-neutral-800 px-2 text-[10px] font-bold text-white">
              Tab
            </span>
            <span>탭 전환</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="inline-flex h-7 w-7 items-center justify-center rounded bg-neutral-800 text-[10px] font-bold text-white">
              ↑
            </span>
            <span className="inline-flex h-7 w-7 items-center justify-center rounded bg-neutral-800 text-[10px] font-bold text-white">
              ↓
