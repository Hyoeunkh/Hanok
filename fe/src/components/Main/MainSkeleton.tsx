  ...
  return (
    <div className="mx-auto flex w-full max-w-[1600px] flex-col gap-6 px-6 pt-8 xl:flex-row">
      <aside className="w-full shrink-0 xl:w-[280px]">
        <div className="rounded-(--radius-panel) border border-white/8 p-3">
        ...
        <div className="mt-5 rounded-(--radius-panel) border border-white/8 p-4">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-6">
        <section className="rounded-(--radius-section) border border-white/8 p-4">
        ...
        <section className="rounded-(--radius-section) border border-white/8 px-6 pb-10 pt-6">
        ...
        <section className="rounded-(--radius-section) border border-white/8 px-6 pb-6 pt-5">
          <div className="flex items-center justify-between gap-4">
