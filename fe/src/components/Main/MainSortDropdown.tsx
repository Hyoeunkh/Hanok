  ...
  return (
    <div ref={dropdownRef} className="relative">
      <button
        ...
        className="inline-flex items-center justify-center gap-2 rounded-(--radius-control) border border-primary-dark/30 bg-surface-elevated px-4 py-2 text-warm transition hover:bg-primary-muted/40"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 top-[calc(100%+8px)] z-30 min-w-full overflow-hidden rounded-(--radius-control) border border-primary-dark/30 bg-surface p-1">
          {options.map((option) => {
